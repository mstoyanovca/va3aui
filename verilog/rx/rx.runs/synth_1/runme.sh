...
HD_PWD='C:/Users/Martin Stoyanov/IdeaProjects/va3aui/verilog/rx/rx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rx_wrapper.tcl
