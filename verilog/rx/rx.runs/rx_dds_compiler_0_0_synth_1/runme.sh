...
HD_PWD='C:/Users/Martin Stoyanov/IdeaProjects/va3aui/verilog/rx/rx.runs/rx_dds_compiler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_dds_compiler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rx_dds_compiler_0_0.tcl
