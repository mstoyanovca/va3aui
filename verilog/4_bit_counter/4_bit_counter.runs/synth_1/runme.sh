...
HD_PWD='C:/Users/Martin Stoyanov/IdeaProjects/va3aui/verilog/4_bit_counter/4_bit_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_counter.tcl
