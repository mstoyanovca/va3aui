...
HD_PWD='C:/Users/Martin Stoyanov/IdeaProjects/va3aui/verilog/4_bit_counter/4_bit_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_bit_counter.tcl -notrace
