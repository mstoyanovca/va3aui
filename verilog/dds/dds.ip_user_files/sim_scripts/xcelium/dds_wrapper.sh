...
#
# Script generated by Vivado on Mon Dec 30 20:34:58 -0500 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dds_wrapper.sh
...
#
# Usage        : dds_wrapper.sh
#                dds_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dds_wrapper.sh [-reset_run]
#                dds_wrapper.sh [-reset_log]
#                dds_wrapper.sh [-help]
#
...
#                script (type 'dds_wrapper.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_13 -libname axi_utils_v2_0_9 -libname xbip_pipe_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_dsp48_multadd_v3_0_9 -libname dds_compiler_v6_0_25 -libname xil_defaultlib -libname xlslice_v1_0_4 -libname sim_clk_gen_v1_0_4 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 dds_compiler_v6_0_25 xil_defaultlib xlslice_v1_0_4 sim_clk_gen_v1_0_4)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "dds_wrapper.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dds_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work xlslice_v1_0_4 $xmvlog_opts \
  ...
  xmvlog -work sim_clk_gen_v1_0_4 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dds_wrapper xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dds_wrapper -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dds_wrapper_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dds_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dds_wrapper.sh [-help]\n\
Usage: dds_wrapper.sh [-step]\n\
Usage: dds_wrapper.sh [-lib_map_path]\n\
Usage: dds_wrapper.sh [-reset_run]\n\
Usage: dds_wrapper.sh [-reset_log]\n\
Usage: dds_wrapper.sh [-keep_index]\n\
Usage: dds_wrapper.sh [-noclean_files]\n\n\
