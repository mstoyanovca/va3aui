...
design_libs=(xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 dds_compiler_v6_0_25 xil_defaultlib xlslice_v1_0_4 sim_clk_gen_v1_0_4)
...
compile()
{
  ...
  vlogan -work xlslice_v1_0_4 $vlogan_opts +v2k \
  ...
  vlogan -work sim_clk_gen_v1_0_4 $vlogan_opts +v2k \
  ...
  "../../../../../../../../Martin/ Stoyanov/IdeaProjects/va3aui/verilog/dds/dds.srcs/sources_1/imports/hdl/dds_wrapper.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dds_wrapper xil_defaultlib.glbl -o dds_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dds_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dds_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dds_wrapper_simv.daidir vcs_lib c.obj)
