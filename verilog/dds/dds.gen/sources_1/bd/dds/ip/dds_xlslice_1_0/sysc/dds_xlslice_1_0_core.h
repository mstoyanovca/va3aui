...
#ifndef _dds_xlslice_1_0_core_h_
#define _dds_xlslice_1_0_core_h_

#include <systemc.h>
#include "properties.h"


class dds_xlslice_1_0_core : public sc_module 
{
    public: 
       dds_xlslice_1_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(dds_xlslice_1_0_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~dds_xlslice_1_0_core() = default;
