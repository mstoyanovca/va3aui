...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../adc.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../adc.gen/sources_1/ip/clk_wiz_0" \
